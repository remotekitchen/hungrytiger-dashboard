	...
	return (
		<div>
          ...
          <li>
            <NavLink
              className={`text-sm text-gray-400 hover:text-gray-500 ${
                pathname === "/services" && "text-blue-600 font-bold"
              }`}
              href="#"
            >
              Services
          ...
          <li>
            <NavLink
              className={`text-sm text-gray-400 hover:text-gray-500 ${
                pathname === "/about-us" && "text-blue-600 font-bold"
              }`}
              href="#"
            >
              Contact
				...
				{auth?.token ? (
					<div className='flex items-center'>
						<div className='dropdown dropdown-end'>
							<label
								tabIndex={0}
								className='btn bg-warning btn-ghost btn-circle'
							>
							...
							<div
								tabIndex={0}
								className='mt-3 z-[1] card card-compact dropdown-content w-96 border-2 bg-base-100 shadow'
							>
