...
const NavbarNew = () => {
	...
	return (
		<nav ref={navRef} className='bg-sky-200 w-full top-0 z-20'>
								...
								<>
									<li className='mt-4 lg:mt-0'>
										<Link
											to='/signin'
											onClick={() => setState(false)}
											className='py-3 px-4 text-center text-white bg-sky-400 hover:bg-sky-700 rounded-md shadow block lg:inline'
										>
											Login
										</Link>
									</li>
