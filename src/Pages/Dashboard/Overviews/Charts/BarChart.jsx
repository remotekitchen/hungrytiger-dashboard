...
const BarChart = ({ selectedLocation }) => {
  const [state, setState] = useState({
    ...
    series1: [
      {
        name: "Sales",
        data: [25, 65, 47, 86, 34, 50, 35],
      },
      {
        name: "Revenue",
        data: [5, 43, 20, 29, 15, 30, 19],
      },
    ],
  });

  return (
    <div className="p-7.5   m-4">
      <button
        onClick={() => window.print()}
        className="btn btn-sm btn-primary block ms-auto my-3"
      >
        Print
      </button>
