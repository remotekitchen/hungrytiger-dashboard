...
const UpdatefissionCampaign = () => {
  const [restaurantIdAllcampaign, setRestaurantIdAllcampaign] = useState("");
  const [bannerImage, setBannerImage] = useState();
  const [selectedFissionRestaurant, setSelectedFissionRestaurant] = useState();
  // console.log(
  //   "🚀 ~ UpdatefissionCampaign ~ selectedFissionRestaurant:",
  //   selectedFissionRestaurant
  // );
  ...
  useEffect(() => {
    if (restaurantList?.results.length > 0) {
      setRestaurantIdAllcampaign(restaurantList.results[0].id);
    }
  }, [restaurantList]);
  ...
  const handleAddFissionCampaign = () => {
    // Check if there are any existing fission campaigns
    if (allFissionCampaigns?.results.length > 0) {
      ...
      setTimeout(() => {
        toast.success("Fission campaign updated successfully!");
      }, 1000);
      navigate("/dashboard/fission-campaigns");
    } else {
      // console.log("No existing fission campaigns found to update.");
    }
  };
                ...
                <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="start_date"
                      name="start_date"
                      defaultValue={duration?.start_date}
                    ...
                    <input
                      ...
                      id="end_date"
                      name="end_date"
                      defaultValue={duration?.end_date}
                      onChange={handleChange}
                      className="mt-1 p-2 border border-gray-300 rounded-md"
                    />
                  </div>
...
export default UpdatefissionCampaign;
